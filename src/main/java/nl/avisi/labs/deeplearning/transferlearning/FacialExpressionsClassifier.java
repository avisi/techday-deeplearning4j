...
@Component
class FacialExpressionsClassifier {
    ...
    FacialExpressionsClassifier() {
        try {
            File dukeComputationGraphFile = new File("FacialExpressionsModel.zip");
            dukeComputationGraph = ModelSerializer.restoreComputationGraph("FacialExpressionsModel.zip");
